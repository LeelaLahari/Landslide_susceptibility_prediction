...
# Add legend
legend("topright", inset = c(-0.25, 0), legend = c("Very Low", "Low", "Medium", "High", "Very High"),
       col = c("blue", "purple", "orange", "green", "red"), lty = 1, xpd = TRUE)
...
df_raster <- as.data.frame(raster_landslide, xy = TRUE, na.rm = TRUE)
